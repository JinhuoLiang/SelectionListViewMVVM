...
namespace SelectionListViewMVVM
{
    /// <summary>
    ...
    public class ListedItemCollection : PropertyChangedObject
    {
        ...
        public ObservableCollection<ListItem> AvailableListItems
        {
            ...
            set
            {
                m_AvailableListItems = value;
                NotifyPropertyChanged("AvailableListItems");
            }
        }
        ...
        public ListItem AvailableSelectedListItem
        {
            ...
            set
            {
                m_AvailableSelectedListItem = value;
                NotifyPropertyChanged("AvailableSelectedListItem");
            }
        }
